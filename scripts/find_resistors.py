...
def main():
    ...
    parser.add_argument("-r", "--resistor-file", default="./resistors.txt", help="Path for file showing list of resistor values.")
...
def get_prime_pair(target_val, r1=None, tol=1, count=0, res_vals=[]):
    ...
    if method == 'select':
        ...
        return
    res = get_prime_pair(target_val, vals[index]['val'], count=count, tol=tol, res_vals=res_vals)
    if res == None:
        return
